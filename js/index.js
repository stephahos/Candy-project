...
let candyArr =[
  {x:Math.random()*canvas.width-70, y:400, img:candy, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-70, y:50, img:blueice, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-70, y:320, img:whitebluecream, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-70, y:120, img:lollipop, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-70, y:580, img:roundPink, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-45, y:690, img:pinkGoldCandy, width:45, height:55, points:5},
  {x:Math.random()*canvas.width-70, y:780, img:icecream, width:70, height:80, points:5},
  {x:Math.random()*canvas.width-70, y:850, img:ourson, width:70, height:80, points:5},
];
